...
LABEL org.label-schema.build-date=$BUILD_DATE \
    ...
    org.label-schema.url="https://github.com/rittme/docker-avahi/" \
    org.label-schema.vcs-ref=$VCS_REF \
    org.label-schema.vcs-url="https://github.com/rittme/docker-avahi.git" \
    org.label-schema.vcs-type="Git" \
    org.label-schema.schema-version="1.0" \
    org.label-schema.version="$AVAHI_VERSION-$AVAHI_RELEASE"
